...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-5 flex justify-between items-center gap-4 sticky top-0 z-50 bg-white shadow-sm lg:shadow-none">
        {/* Logo */}
        <div>
          <img
            src={logo}
